...
| 用途 | 大小 | 说明 |
|---|---|---|
| LVGL 帧缓冲区 | 466 × 466 × 2B × 2 buf = 866 KB | 双缓冲 RGB565 |
| LVGL 内部内存池 | 512 KB | LV_MEM_SIZE |
| 摄像头 JPEG 缓冲 | 512 KB | 单帧 JPEG ≤ 300KB |
| Opus 编解码缓冲 | 64 KB | 语音帧 |
| MQTT 消息缓冲 | 128 KB | 大消息支持 |
| HTTP 上传分块缓冲 | 256 KB | 上传录音 / 照片 |
| 位置数据缓存 | 256 KB | 24h 离线位置 |
| AT 命令缓冲 | 64 KB | 长 AT 响应 |
| HTTPS TLS 缓冲 | 128 KB | mbedTLS 工作区 |
| App 状态 / 业务 | 1 MB | 各种动态分配 |
| **小计** | **~4 MB** | 留 4 MB 安全余量 |
